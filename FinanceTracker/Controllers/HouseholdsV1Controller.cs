...
public class HouseholdsV1Controller : ControllerBase
{
    ...
    {
        var household = await _sender.Send(new GetMyHouseholdQuery(), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<HouseholdResponseDto>>> CreateHousehold(
        ...
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new CreateHouseholdCommand(dto), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<HouseholdResponseDto>>> RenameHousehold(
        ...
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new RenameHouseholdCommand(dto), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<object>>> LeaveHousehold(
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new LeaveHouseholdCommand(), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<HouseholdResponseDto>>> RemoveMember(
        Guid memberUserId,
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new RemoveHouseholdMemberCommand(memberUserId), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<HouseholdInvitationDto>>> Invite(
        ...
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new InviteHouseholdMemberCommand(dto), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<object>>> RevokeInvitation(
        Guid invitationId,
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new RevokeHouseholdInvitationCommand(invitationId), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<HouseholdResponseDto>>> AcceptInvitation(
        Guid invitationId,
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new RespondToHouseholdInvitationCommand(invitationId, Accept: true), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<HouseholdResponseDto>>> DeclineInvitation(
        Guid invitationId,
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new RespondToHouseholdInvitationCommand(invitationId, Accept: false), cancellationToken);
