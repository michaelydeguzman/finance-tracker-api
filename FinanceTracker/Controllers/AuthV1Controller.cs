...
public class AuthV1Controller : ControllerBase
{
    ...
    [HttpPost("register")]
    public async Task<ActionResult<ApiResponseDto<object>>> Register(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _sender.Send(new RegisterCommand(dto), cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var result = await _sender.Send(new ExchangeExternalLoginCommand(dto), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<object>>> RequestMagicLink(
        [FromBody] EmailOnlyRequestDto dto,
        CancellationToken cancellationToken = default)
    {
        await _sender.Send(new RequestMagicLinkCommand(dto), cancellationToken);
        return Accepted(ApiResponseDto<object>.Ok(null!, NeutralAcknowledgement));
    }

    [HttpPost("magic-link/consume")]
    public async Task<ActionResult<ApiResponseDto<AuthResultDto>>> ConsumeMagicLink(
        [FromBody] TokenRequestDto dto,
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new ConsumeMagicLinkCommand(dto), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<object>>> RequestPasswordReset(
        [FromBody] EmailOnlyRequestDto dto,
        CancellationToken cancellationToken = default)
    {
        await _sender.Send(new RequestPasswordResetCommand(dto), cancellationToken);
        return Accepted(ApiResponseDto<object>.Ok(null!, NeutralAcknowledgement));
    }

    [HttpPost("password-reset/confirm")]
    public async Task<ActionResult<ApiResponseDto<object>>> ResetPassword(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var succeeded = await _sender.Send(new ResetPasswordCommand(dto), cancellationToken);
    ...
    public async Task<ActionResult<ApiResponseDto<object>>> RequestEmailVerification(
        ...
        CancellationToken cancellationToken = default)
    {
        await _sender.Send(new RequestEmailVerificationCommand(dto), cancellationToken);
        return Accepted(ApiResponseDto<object>.Ok(null!, NeutralAcknowledgement));
    }
    ...
    public async Task<ActionResult<ApiResponseDto<AuthResultDto>>> Refresh(
        ...
        CancellationToken cancellationToken = default)
    {
        var result = await _sender.Send(new RefreshSessionCommand(dto), cancellationToken);
